...
func ValidatePriorityClass(pc *scheduling.PriorityClass) field.ErrorList {
	...
	if pc.PreemptionPolicy != nil {
		if *pc.PreemptionPolicy != core.PreemptLowerPriority && *pc.PreemptionPolicy != core.PreemptNever {
...
func ValidatePriorityClassUpdate(pc, oldPc *scheduling.PriorityClass) field.ErrorList {
	...
	allErrs = append(allErrs, apivalidation.ValidateImmutableField(pc, oldPc, field.NewPath("PreemptionPolicy"))...)
	return allErrs
}

...
var map_PriorityClass = map[string]string{
	...
	"nonPreempting": "nonPreempting specifies whether a pod with this PriorityClass could trigger a preemption process. If this field is unset, the PriorityClass is considered a preempting class by default.",
}

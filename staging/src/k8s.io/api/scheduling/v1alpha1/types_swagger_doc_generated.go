...
var map_PriorityClass = map[string]string{
	...
	"preemptionPolicy": "PreemptionPolicy specifies whether a pod with this PriorityClass could trigger a preemption process. This field is alpha-level and is only honored by servers that enable the NonPreemptingPriority feature.",
}

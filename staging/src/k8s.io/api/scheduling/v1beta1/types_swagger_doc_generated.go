...
var map_PriorityClass = map[string]string{
	...
	"preemptionPolicy": "PreemptionPolicy is the Policy for preempting pods with lower priority. This field is alpha-level and is only honored by servers that enable the NonPreemptingPriority feature.",
}

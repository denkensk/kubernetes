...
var map_PodSpec = map[string]string{
	...
	"preemptionPolicy":              "Preempting specifies whether a pod with this PriorityClass could start a preemption process. This field is alpha-level and is only honored by servers that enable the NonPreemptingPriority feature.",
